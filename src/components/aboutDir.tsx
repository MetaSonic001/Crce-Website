    ...
    <div className="mt-[80px] flex min-h-screen w-full items-center justify-center bg-linear-to-b from-white to-[#E5F0FF] pt-20 md:pt-0">
      <main className="container mx-auto px-4">
        <div className="rounded-xl bg-white p-10 shadow-lg">
          <h2 className="font-serif mb-10 text-center text-3xl md:text-5xl font-semibold text-blue-950">
            Director's Message
          </h2>
          <div className="flex flex-col items-center lg:flex-row lg:items-start">
            ...
            <div className="lg:ml-8 lg:w-2/3">
              ...
              <p className="font-roboto mb-4 text-justify leading-relaxed text-gray-700">
              ...
              <p className="font-roboto mb-6 text-justify leading-relaxed text-gray-700">
