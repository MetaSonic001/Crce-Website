  ...
  return (
    <div className="container mx-auto px-3 sm:px-6 py-6 sm:py-8">
      ...
      <div className="relative mb-8 sm:mb-12 flex items-center justify-center">
        <div className="absolute left-0 top-1/2 h-px w-[15%] sm:w-1/4 bg-gray-300"></div>
        <h2 className={`${zilla.className} mx-4 sm:mx-8 text-center text-3xl sm:text-4xl font-bold text-[#131929]`}>
          HOD's Desk
        </h2>
        <div className="absolute right-0 top-1/2 h-px w-[15%] sm:w-1/4 bg-gray-300"></div>
      </div>

      <div className="overflow-hidden rounded-lg bg-white shadow-lg">
        <div className="flex flex-col md:flex-row">
          {/* Left column with image and details */}
          <div className="flex flex-col items-center bg-white p-4 sm:p-8 w-full md:w-1/4">
            <div className="mb-4 overflow-hidden rounded shadow-2xl max-w-[180px] md:max-w-none">
              <Image
                src={imageUrl}
                alt={name}
                width={220}
            ...
            <h3 className="mb-1 text-center md:text-left text-xl font-bold text-black">{name}</h3>
            <p className="mb-3 text-center md:text-left font-medium text-black">{title}</p>
            <p className="mb-4 text-center md:text-left text-sm text-black italic">{qualification || "Ph.D. in Computer Engineering"}</p>
          ...
          <div className="flex flex-col p-4 sm:p-8 w-full md:w-3/4">
      ...
      <div className="mt-6 sm:mt-8 rounded-lg bg-white p-4 sm:p-6 shadow-md">
        <h3 className={`${zilla.className} mb-3 sm:mb-4 text-xl sm:text-2xl font-bold text-[#131929]`}>Message to Students</h3>
        <div className="text-justify">
          <p className="mb-3 sm:mb-4 text-gray-700 leading-relaxed">
            Dear Students,
          </p>
          <p className="mb-3 sm:mb-4 text-gray-700 leading-relaxed">
            Welcome to Fr. CRCE. We are committed to providing you with a comprehensive education that blends theoretical knowledge with practical skills. Our goal is to prepare you not just for your first job, but for a successful and fulfilling career in the ever-evolving field of computer engineering.
          </p>
          <p className="mb-3 sm:mb-4 text-gray-700 leading-relaxed">
          ...
          <p className="mt-5 sm:mt-6 text-right font-semibold text-[#131929]">{name}</p>
