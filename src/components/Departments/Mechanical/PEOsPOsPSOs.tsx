    ...
    <div className="container mx-auto px-4 py-6 sm:px-6 sm:py-8">
      ...
      <div className="mb-10 sm:mb-16">
        ...
        <div className="relative mb-6 sm:mb-8 flex items-center">
          <div className="absolute left-0 top-1/2 h-px w-8 sm:w-16 bg-gray-300"></div>
          <h2 className={`${zilla.className} ml-12 sm:ml-24 text-2xl sm:text-3xl font-bold text-[#131929]`}>
            Program Educational Objectives (PEOs)
          </h2>
        </div>
        <div className="rounded-lg bg-white p-5 sm:p-8 shadow-md">
          <p className="mb-4 sm:mb-6 text-base sm:text-lg leading-relaxed text-gray-700">
          ...
          <div className="space-y-4 sm:space-y-6">
            <div className="rounded-lg bg-[#F5F8FF] p-4 sm:p-6">
              <h3 className="mb-2 sm:mb-3 text-lg sm:text-xl font-semibold text-[#131929]">PEO 1: Professional Excellence</h3>
            ...
            <div className="rounded-lg bg-[#F5F8FF] p-4 sm:p-6">
              <h3 className="mb-2 sm:mb-3 text-lg sm:text-xl font-semibold text-[#131929]">PEO 2: Core Competence</h3>
              <p className="text-sm sm:text-base leading-relaxed text-gray-700">
            ...
            <div className="rounded-lg bg-[#F5F8FF] p-4 sm:p-6">
              <h3 className="mb-2 sm:mb-3 text-lg sm:text-xl font-semibold text-[#131929]">PEO 3: Professionalism</h3>
              <p className="text-sm sm:text-base leading-relaxed text-gray-700">
            ...
            <div className="rounded-lg bg-[#F5F8FF] p-4 sm:p-6">
              <h3 className="mb-2 sm:mb-3 text-lg sm:text-xl font-semibold text-[#131929]">PEO 4: Learning Environment</h3>
              <p className="text-sm sm:text-base leading-relaxed text-gray-700">
      ...
      <div className="mb-10 sm:mb-16">
        ...
        <div className="rounded-lg bg-white p-5 sm:p-8 shadow-md">
          ...
          <div className="space-y-4 sm:space-y-6">
            <div className="rounded-lg bg-[#F5F8FF] p-4 sm:p-6">
              <h3 className="mb-2 sm:mb-3 text-lg sm:text-xl font-semibold text-[#131929]">PO 1: Engineering Knowledge</h3>
              <p className="text-sm sm:text-base leading-relaxed text-gray-700">
            ...
            <div className="rounded-lg bg-[#F5F8FF] p-4 sm:p-6">
              <h3 className="mb-2 sm:mb-3 text-lg sm:text-xl font-semibold text-[#131929]">PO 2: Problem Analysis</h3>
              <p className="text-sm sm:text-base leading-relaxed text-gray-700">
                Identify, formulate, review research literature, and analyze complex engineering problems reaching substantiated conclusions using first principles of mathematics, natural sciences, and engineering sciences.
              </p>
            </div>
            <div className="rounded-lg bg-[#F5F8FF] p-4 sm:p-6">
              <h3 className="mb-2 sm:mb-3 text-lg sm:text-xl font-semibold text-[#131929]">PO 3: Design/Development of Solutions</h3>
              <p className="text-sm sm:text-base leading-relaxed text-gray-700">
      ...
      <div className="mb-8 sm:mb-12">
        ...
        <div className="rounded-lg bg-white p-5 sm:p-8 shadow-md">
          ...
          <div className="space-y-4 sm:space-y-6">
            <div className="rounded-lg bg-[#F5F8FF] p-4 sm:p-6">
              <h3 className="mb-2 sm:mb-3 text-lg sm:text-xl font-semibold text-[#131929]">PSO 1: Professional Skills</h3>
              <p className="text-sm sm:text-base leading-relaxed text-gray-700">
            ...
            <div className="rounded-lg bg-[#F5F8FF] p-4 sm:p-6">
              <h3 className="mb-2 sm:mb-3 text-lg sm:text-xl font-semibold text-[#131929]">PSO 2: Problem-Solving Skills</h3>
              <p className="text-sm sm:text-base leading-relaxed text-gray-700">
            ...
            <div className="rounded-lg bg-[#F5F8FF] p-4 sm:p-6">
              <h3 className="mb-2 sm:mb-3 text-lg sm:text-xl font-semibold text-[#131929]">PSO 3: Successful Career and Entrepreneurship</h3>
              <p className="text-sm sm:text-base leading-relaxed text-gray-700">
