  ...
  return (
    <div className="flex h-fit w-full flex-col bg-linear-to-b from-white to-[#E5F0FF] px-2 text-gray-900">
      ...
      <div className="container mx-auto w-full p-4 px-4 md:p-0 md:px-28 md:py-16">
        <div className="mb-16">
          <h2
            className={`${zilla.className} mb-6 text-2xl font-bold text-[#001f3f] md:text-2xl`}
          >
          ...
          <div className="rounded-lg bg-white p-6 shadow-lg">
            ...
            <p className="mb-6 text-gray-700">
              View the complete academic calendar including examination dates,
              holidays, and important academic events for the current academic
              year. This document contains all the essential dates and schedules
              for students and faculty.
            </p>

            <div className="h-[600px] w-full md:h-[800px]">
              <object
        ...
        <div className="mb-16">
          ...
          <div className="rounded-lg bg-white p-6 shadow-lg">
            <p className="mb-4 text-gray-700">
              Please refer to this calendar regularly for updates on academic
              schedules, examination dates, and institutional holidays. All
              dates are subject to change as per university guidelines.
            </p>
            <p className="text-gray-700">
              For any clarifications regarding the academic calendar, please
              contact the academic administration office.
            </p>
          </div>
        </div>
