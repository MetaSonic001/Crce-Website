              ...
              <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-200 rounded-lg bg-white shadow">
                  ...
                  <tbody className="divide-y divide-gray-200">
                    {tabContents.Placements && tabContents.Placements.packageData?.map((data, index) => (
                      <tr key={index} className={index % 2 === 0 ? 'bg-white' : 'bg-[#F9FAFC]'}>
                        <td className="whitespace-nowrap px-6 py-4 text-sm font-medium text-gray-900">
                          {data.highestCompany}
                        </td>
                        <td className="whitespace-nowrap px-6 py-4 text-sm text-gray-700">Software Engineer</td>
                        <td className="whitespace-nowrap px-6 py-4 text-sm text-gray-700">{data.highest}</td>
                        <td className="whitespace-nowrap px-6 py-4 text-sm text-gray-700">Bangalore</td>
                        <td className="whitespace-nowrap px-6 py-4 text-sm text-gray-700">{data.year}</td>
                      </tr>
                    ))}
                    {(!tabContents.Placements || !tabContents.Placements.packageData || tabContents.Placements.packageData.length === 0) && (
                      <tr className="bg-white">
                        <td className="whitespace-nowrap px-6 py-4 text-sm font-medium text-gray-900">Example Company</td>
                        <td className="whitespace-nowrap px-6 py-4 text-sm text-gray-700">Software Engineer</td>
                        <td className="whitespace-nowrap px-6 py-4 text-sm text-gray-700">12 LPA</td>
                        <td className="whitespace-nowrap px-6 py-4 text-sm text-gray-700">Bangalore</td>
              ...
              <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-200 rounded-lg bg-white shadow">
                  ...
                  <tbody className="divide-y divide-gray-200">
                    <tr className="bg-white">
                      <td className="whitespace-nowrap px-6 py-4 text-sm font-medium text-gray-900">Example Company</td>
                      <td className="whitespace-nowrap px-6 py-4 text-sm text-gray-700">Software Engineer Intern</td>
                      <td className="whitespace-nowrap px-6 py-4 text-sm text-gray-700">20,000/month</td>
