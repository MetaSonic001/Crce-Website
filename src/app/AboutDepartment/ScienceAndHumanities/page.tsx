...
// Tab configuration - Matching Mech structure
const TABS = [
  { id: 'about', title: 'About Science and Humanities' },
  ...
  //{ id: 'placements', title: 'Higher Studies and Placements' },
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="relative mb-12 flex items-center justify-center">
          ...
          <h2 className="mx-8 text-center text-4xl font-bold text-[#131929]">
            Higher Studies & Placement Statistics
          </h2>
          ...
          {activeSubTab === 'placements' ? (
            <div>
              <p className="mb-8 text-lg leading-relaxed text-gray-700">
                Our department has an impressive placement record with students securing positions in top companies across various sectors.
              </p>
                ...
                <table className="min-w-full divide-y divide-gray-200 rounded-lg bg-white shadow">
                  <thead className="bg-[#F5F8FF]">
                    <tr>
                      ...
                      <th className="px-6 py-4 text-left text-sm font-semibold uppercase tracking-wider text-[#131929]">Highest Package</th>
                      <th className="px-6 py-4 text-left text-sm font-semibold uppercase tracking-wider text-[#131929]">Company</th>
                      <th className="px-6 py-4 text-left text-sm font-semibold uppercase tracking-wider text-[#131929]">Lowest Package</th>
                      <th className="px-6 py-4 text-left text-sm font-semibold uppercase tracking-wider text-[#131929]">Company</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-gray-200">
                    {tabContents.Placements.packageData.map((data, index) => (
                      <tr key={index} className={index % 2 === 0 ? 'bg-white' : 'bg-[#F9FAFC]'}>
                        <td className="whitespace-nowrap px-6 py-4 text-sm font-medium text-gray-900">{data.year}</td>
                        <td className="whitespace-nowrap px-6 py-4 text-sm text-gray-700">{data.highest}</td>
                        <td className="whitespace-nowrap px-6 py-4 text-sm text-gray-700">{data.highestCompany}</td>
                        <td className="whitespace-nowrap px-6 py-4 text-sm text-gray-700">{data.lowest}</td>
                        <td className="whitespace-nowrap px-6 py-4 text-sm text-gray-700">{data.lowestCompany}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
            ...
            <div>
              <p className="mb-8 text-lg leading-relaxed text-gray-700">
                Our students have been recruited by leading organizations across various sectors. Below are some of our key recruiting partners.
              </p>
